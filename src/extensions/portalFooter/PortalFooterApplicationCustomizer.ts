...
import * as string from 'PortalFooterApplicationCustomizerStrings';
...
import { stringIsNullOrEmpty } from '../../../node_modules/@pnp/common';
...
export default class PortalFooterApplicationCustomizer
  ...
  public async onInit(): Promise<void> {
    ...
    Log.info(LOG_SOURCE, `Initialized ${string.Title}`);
